...
=======
	if BMI < 18.5{
		...
		$('#results').append('<p> Hello Healthy, you are doing well')
		$('#results').addClass('bg-sucess');
	}

	else (BMI > 25){
		$('#results').append('<p> Hello fatty wannabe, you should start shaking off with workout')
		$('#results').addClass('bg-warning');
	}
